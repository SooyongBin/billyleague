                ...
                {playerStats.length > 0 ? (
                  playerStats.map((player) => (
                    <tr key={player.player_name}>
                      ...
                      <td className="py-2 px-4 border-b text-center"> {/* Combined name and handicap */}
                        <Link href={`/player/${player.player_name}`} className="text-blue-600 hover:underline">
                          {player.player_name}({player.handicap})
                        </Link>
                      </td>
                  ...
                  <tr>
                    <td colSpan={5} className="text-center py-4 text-gray-500"> {/* colSpan adjusted to 5 */}
                      데이터 없음
                    </td>
                  </tr>
                )}
